...
from training_modules import data, models, constants
...
class InferenceAPI:
    ...
    def infer_all(self, output_file: Optional[Path] = None) -> None:
        ...
        if should_save_output:
            with open(output_file) as f: # write to json
                json.dump(prompt_and_answers, f, indent=4)
